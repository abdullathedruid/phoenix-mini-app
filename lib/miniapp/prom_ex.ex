defmodule Miniapp.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule MiniappWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :miniapp
  ...
  def dashboards do
    [
      ...
      # {:miniapp, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
